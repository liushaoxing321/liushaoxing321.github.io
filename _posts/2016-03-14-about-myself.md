...
>####工作经历
 	在北京专职余iOS开发3年。之前在外包公司待过2年,开发过聊天、洗车、外卖、旅游、智能家居、视频、报刊等各种APP.现在北京朝阳一家公司就职iOS开发工程师组长。
...
6.类和对象,实例变量、属性和方法.类的扩展（协议，类目，延展）,类之间的通信:delegate（代理），`Notification`（通知），`Block`（块语法），KVO/KVC，单例  
7.面向对象的三大特性：封装，继承和多态（基本了解）  
8.内存管理  
